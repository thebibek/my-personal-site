...
if (isset($_POST['add_service'])) {
    ...
    $sql = mysql_query("SELECT page_heading FROM page WHERE page_heading = '$page_heading'") or die(mysql_error());
    ...
    else
    {
        ...
        $insert = mysql_query("INSERT INTO page (page_heading,page_title,page_keyword,page_description,page_full,page_type,post_date,post_time,post_by,image,url) VALUES ('$page_heading','$page_title','$page_keyword','$page_description','".$page_full."','news',CURDATE(),CURTIME(),'$user_id','$image','$url')") or die(mysql_error());
        if ($insert) {
            store_log($user_id, $user_fullname.' added news '.$page_heading);
            $message = 'News has been Added.';
        }
        else
        {
            $error = 'News Can\'t be save Try again!!!';
        } 
    }
                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="news.php">News Management</a></li>
                                                ...
                                                <div class="modal-wrapper">
                                                    <div class="ibox-content">
                                                        <div class="col-sm-12 form-group">
                                                            <label class="col-sm-2 col-form-label pull-left">News Title</label>
                                            ...
                                            <footer class="panel_hwc_modal-footer">
                                                <div class="row">
                                                    <div class="col-md-12 text-right">
                                                        <button type="submit" name="add_service" class="btn btn-primary "><i class="fa fa-plus text-white"></i> Add News</button>
                ...
                <section class="panel_hwc_modal">
                    ...
                    <form action="" method="post" accept-charset="utf-8">
                        ...
                        <footer class="panel_hwc_modal-footer">
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <a href="news.php" class="btn btn-success">Okay</a>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </footer>
