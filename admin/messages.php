                    ...
                    <div class="container-fluid">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Message Management</li>
                            </ol>
                        </nav>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    <div class="ibox-title">
                                        <h5 class="mb-30">Message Management </h5>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="grade">
                                                            ...
                                                            <td class="center"> 
                                                                <a class="simple-ajax-popup" href="ajax.php?view_message=<?php print $row->id; ?>"> <i class="fa fa-eye"></i> </a>
