$(function () {
    ...
    var lineData = {
        ...
        datasets: [
            ...
            {
                label: "Data 1",
                backgroundColor: 'rgba(113, 106, 202, 0.50)',
                borderColor: "rgba(50, 202, 254, 0.65)",
                pointBackgroundColor: "rgba(26,179,148,2)",
    ...
    var barData = {
        ...
        datasets: [
            ...
            },
            {
                ...
                pointBackgroundColor: "rgba(50, 202, 254, 0.7)",
                pointBorderColor: "#fff",
                data: [28, 48, 40, 19, 86, 27, 90]
            }
        ]
    ...
    var polarData = {
        datasets: [{
            ...
            backgroundColor: [
                'rgba(113, 106, 202, 0.50)', "rgba(19, 132, 150, 0.9)", "#b5b8cf"
            ],
            label: [
                "My Radar chart"
            ]
    ...
    var doughnutData = {
        ...
        datasets: [{
            data: [300,50,100],
            backgroundColor: ['rgba(113, 106, 202, 0.50)',"#dedede","#b5b8cf"]
        }]
    } ;
